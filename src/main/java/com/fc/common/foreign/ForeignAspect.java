package com.fc.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.fc.common.foreign.anno.ForeignCascade;
import com.fc.common.foreign.anno.ForeignField;
import com.fc.common.foreign.anno.ForeignField.ForeignFields;
import com.fc.common.foreign.info.ForeignFieldInfo;
import com.fc.common.foreign.info.ForeignTableInfo;
import com.fc.common.util.Classes;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/fc/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.fc.service..*.remove*(..))")
    ...
    @Around("execution(* com.fc.service..*.save*(..)) || execution(* com.fc.service..*.update*(..)) ")
